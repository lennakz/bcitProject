      ...
      <div id="lecture" class="tab-pane fade in active">
        ...
        <section>
          ...
          <ul>
          	...
          	<li><a href="http://bcitcomp.ca/_shared_resources_1950/downloads/css_per_media.zip">Download and examine css media example files</a>, test them after publishing online. Examine the code to see how they work.</li>
        ...
        <section>
          ...
          <ul>
          	...
          	<li><a href="http://bcitcomp.ca/_shared_resources_1950/downloads/alternate_stylesheets_solution.zip">Download a sample solution</a></p></li>
          </ul>
        </section>
        <section>
          ...
          <h3>Embedded Example:</h3>
        	...
        	<pre><code>&lt;style type="text/css" media="all"&gt;@import url("/css/rich_styles.css");&lt;/style&gt;</code></pre>
        ...
        <section>
          <h2>Exercise #2: Using @import</h2>
            <ul>
            	...
            	<li>Show your instructor when complete</li>
              <li><a href="http://bcitcomp.ca/_shared_resources_1950/downloads/importing_css_solution.zip">Download a sample solution</a></p></li>
            </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <section>
            <ul>
            	<li>
                The <a href="https://developer.mozilla.org/en/docs/Web/CSS/font">shorthand code for font styles</a> might look like this:<br />
        ...
        <section>
          ...
          <p>Lets try some examples with a <a href="http://bcitcomp.ca/_shared_resources_1950/downloads/advanced_css_selectors.html">sample page</a>. To add CSS, use either a tool like Firebug or download the html page and alter it in a text editor. You can examine an <a href="http://bcitcomp.ca/_shared_resources_1950/downloads/advanced_css_selectors_complete.html">updated sample page</a> to see completed examples of the advanced CSS selectors.  </p>
        </section>
        <section>
