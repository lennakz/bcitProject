...
<ul class="nav nav-tabs">
  ...
  <li><a data-toggle="tab" href="?id=3#excercises">Excercises</a></li>
...
<div class="tab-content">
  ...
  <div id="lecture" class="tab-pane fade in active">
    <div id="">
      ...
      <div class="">
        ...
        <h3>Media variations: <code>media</code> attribute</h3>
        <ul>
        	...
        	<li><a href="/_shared_resources_1950/downloads/css_per_media.zip">Download and examine css media example files</a>, test them after publishing online. Examine the code to see how they work.</li>
        ...
        <ul>
        	<li>A stylesheet is "persistent" if it is linked with <code>rel="stylesheet"</code> and has no <code>title</code> attribute. All persistent stylesheets are always used when rendering</li>
      ...
      <div class="">
        <ul>
        	<li><a href="/_shared_resources_1950/downloads/alternate_stylesheets.zip">Download the alternate stylesheet starting files</a></li>
        	...
        	<li><a href="/_shared_resources_1950/downloads/alternate_stylesheets_solution.zip">Download a sample solution</a></p></li>
        </ul>
      </div>
      ...
      <div class="">
        <ul>
        	<li><a href="/_shared_resources_1950/downloads/importing_css.zip">Download the css import exercise starting files</a></li>
        	...
        	<li>Show your instructor when complete</li>
          <li><a href="/_shared_resources_1950/downloads/importing_css_solution.zip">Download a sample solution</a></p></li>
        </ul>
      </div>

      <h2>Simplifying your CSS</h2>
      <div class="">
        <p>When building your CSS rules, there are some easy ways to compact your code.</p>
        ...
        <h3>Grouping comes to Classes</h3>
          <ul>
        	...
        	<li>Define several classes: <code>.cool{ color:red; } .wicked { border:1px solid black; }</code></li>
        	<li>Assign several classes at once: <code>&lt;p class="cool wicked"&gt;</code> will select both the <code>cool</code> and <code>wicked</code> classes</li>
        ...
        <h3>Rule Compacting</h3>
          <ul>
        	...
        	<li>Padding</li>
        	<li>Margin</li></ul></li>
        	<li>Example pattern for border and font shorthand patterns:
        		<ul>
        			<li><code><a href="https://developer.mozilla.org/en/docs/Web/CSS/border">border</a>: width style color;</code></li>
        			<li><code><a href="https://developer.mozilla.org/en/docs/Web/CSS/font">font</a>: font-style font-variant font-weight font-size/line-height font-family;</code></li>
        		</ul>
        	</li>
        	...
        	<li>The <a href="https://developer.mozilla.org/en/docs/Web/CSS/font">shorthand code for font styles</a> might look like this:<br />
      ...
      <div class="">
        ...
        <p>Lets try some examples with a <a href="/_shared_resources_1950/downloads/advanced_css_selectors.html">sample page</a>. To add CSS, use either a tool like Firebug or download the html page and alter it in a text editor. You can examine an <a href="/_shared_resources_1950/downloads/advanced_css_selectors_complete.html">updated sample page</a> to see completed examples of the advanced CSS selectors.  </p>
      </div>

      <h2>Exercise #3: Advanced Selectors</h2>
      <div class="">
        <ul>
      	<li><a href="/_shared_resources_1950/downloads/css_selector_exercise.zip">Download the exercise source files</a></li>
      	...
      	<li>Show your instructor when complete</li>
        <li><a href="/_shared_resources_1950/downloads/css_selector_exercise_sample.zip">Download a sample solution</a></li>
      </ul>
      </div>
      ...
      <div class="">
        ...
        <h3>Size measurements</h3>
          <ul>
        	...
        	<li><strong>rem</strong> - Similar to <code>em</code>, this will inherit only the Root value, helpful for avoiding 'compound inheritance' values</li>
  ...
  <!-- Excercises tab -->
  <div id="excercises" class="tab-pane fade">
    <h3>CodePen Example</h3>
    <p>We can implement something like this for examples or exercises. We can use any code and see the result or hide it and expand when needed.</p>
    <p data-height="400" data-theme-id="0" data-slug-hash="xqPjJd" data-default-tab="css,result" data-user="enricator" data-embed-version="2" data-pen-title="CSS atom animation" class="codepen">See the Pen <a href="http://codepen.io/enricator/pen/xqPjJd/">CSS atom animation</a> by Enrico Imbalzano (<a href="http://codepen.io/enricator">@enricator</a>) on <a href="http://codepen.io">CodePen</a>.</p>
  ...
  <div id="homework" class="tab-pane fade">
    ...
    <div class="">
        ...
        <li>homework specifications will be available here upon release. check back later for an active download link</li>
      	<li><a href="/_shared_resources_1950/downloads/comp1950_homework03.pdf">download the homework</a></li>
    	</ul>
    </div>
  </div>
  <!-- End Homework tab -->
