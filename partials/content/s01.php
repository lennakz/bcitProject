		...
		<section class="remove">
			...
			<div class="tab-content">
			  ...
			  <div id="lecture" class="tab-pane fade in active">
			    ...
			    <h2>Introductions</h2>
					<ul>
						<li> <b>instructors:</b> <br>Jeff Parker (<a href="mailto:jeffrey_parker@bcit.ca">jeffrey_parker@bcit.ca</a>), <br>Lynda Williams (<a href="mailto:lynda_williams@bcit.ca">lynda_williams@bcit.ca</a>)</li>
